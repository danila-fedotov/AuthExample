...
COMMIT;";
        ...
        public virtual void DeleteUser(string id, string actionNote)
        {
            var sqlQuery = @"
BEGIN TRANSACTION;

INSERT INTO User (Id, Email, FirstName, SecondName, Birthday, _IsActive, _ActionNote, _CreatedDate, _CreatedByUserId)
    SELECT Id, Email, FirstName, SecondName, Birthday, 0, @actionNote, @CreatedDate, @CreatedByUserId 
    FROM User 
    WHERE Id=@id AND _IsActive=1;
